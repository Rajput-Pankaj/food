    ...
    <PageLayout searchQuery={searchQuery} setSearchQuery={handleSearchQueryChange}>
      ...
      <div className="bg-slate-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-5 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-white rounded-xl border border-gray-100 px-3 sm:px-4 py-3">
            ...
            <div className="flex items-center gap-2 sm:gap-4 order-1 sm:order-2">
              <div className="flex items-center gap-2 flex-1 sm:flex-none">
                ...
                <select
                  ...
                  className="w-full sm:w-auto px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-green-500 bg-white"
